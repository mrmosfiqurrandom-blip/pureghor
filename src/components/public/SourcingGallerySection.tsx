...
const GALLERY_ITEMS: GalleryItem[] = [
  {
    ...
    titleBn: 'কালোজিরা ফুলের প্রাকৃতিক মধু বোতলজাতকরণ',
    locationBn: 'PureGhor ন্যাচারাল সোর্সিং',
    descriptionBn: 'কালোজিরা ফুলের প্রাকৃতিক মধু কোনো প্রকার হিটিং বা কৃত্রিম চিনি ছাড়াই সরাসরি স্বাস্থ্যসম্মত বোতলজাত করা হয়।',
    imageUrl: '/images/pureghor/778160023_1968999603762127_8330157447235278502_n.jpeg',
  ...
  },
  {
    ...
    locationBn: 'PureGhor শোরুম ডিসপ্লে',
  ...
  },
  {
    ...
    imageUrl: '/images/pureghor/779050252_2644299516029094_7573122435296028448_n.jpeg',
  ...
  },
  {
    ...
    imageUrl: '/images/pureghor/778972309_1922577025083385_4765835242500284291_n.jpeg',
  ...
  },
  {
    ...
    titleBn: 'কোয়েকার ওটস পাউচ ৯০০ গ্রাম হোল গ্রেইন',
    locationBn: 'আমদানিকৃত প্রিমিয়াম গ্রেড',
    descriptionBn: 'হার্টের স্বাস্থ্য ও ওজন নিয়ন্ত্রণে আদর্শ সকালের পুষ্টিকর হোল গ্রেইন ওটস।',
    imageUrl: '/images/pureghor/722119294_1968026900508945_6535640957699175289_n.jpeg',
    productSlug: 'quaker-oats-pouch-900g',
  ...
  },
  {
    ...
    badgeBn: 'বেবি ওটস প্যাক',
  },
  {
    id: 'sg-fresh-mangoes',
    category: 'fruits',
    categoryLabelBn: 'মৌসুমি ফল',
    titleBn: 'বাগান থেকে সরাসরি বাছাইকৃত রাসায়নিকমুক্ত কাঁচা আম',
  ...
  },
  {
    ...
    category: 'fruits',
    categoryLabelBn: 'মৌসুমি ফল',
    titleBn: 'তাজা সংগৃহীত আমের খাঁচা প্যাকেজিং ও ডেলিভারি',
    locationBn: 'বাগান থেকে সরাসরি প্যাকেজিং',
    descriptionBn: 'নিরাপদ কাঠের খাঁচায় সুরক্ষিতভাবে মোড়ানো তাজা আম সরাসরি গ্রাহকের দ্বারে।',
  ...
  },
  {
    ...
    imageUrl: '/images/pureghor/767222273_2024587104840457_7840408175303308981_n.jpeg',
    badgeBn: 'শোরুম সেলফ',
  },
  {
    id: 'sg-store-lalabazar',
    category: 'outlets',
    categoryLabelBn: 'আমাদের আউটলেট',
    titleBn: 'লালাবাজার প্রধান শোরুমের প্রবেশদ্বার ও সাইনবোর্ড',
    locationBn: 'লালাবাজার পয়েন্ট, সিলেট',
    descriptionBn: 'সিলেটের লালাবাজারে অবস্থিত PureGhor-এর প্রধান শোরুম।',
    imageUrl: '/images/pureghor/770904230_1361254559313600_8154638867458334584_n.jpeg',
    badgeBn: 'লালাবাজার শাখা',
  },
  {
    id: 'sg-store-biswanath',
    category: 'outlets',
    categoryLabelBn: 'আমাদের আউটলেট',
    titleBn: 'বিশ্বনাথ শাখা আউটলেটের ক্যাশ কাউন্টার ও ইনডোর',
    locationBn: 'আল বুরাক শপিং সিটি, বিশ্বনাথ',
    descriptionBn: 'বিশ্বনাথ শাখায় উদ্বোধনী ১০% ছাড়ে খাঁটি খাদ্য কেনাকাটার সুবিধা।',
    imageUrl: '/images/pureghor/701850019_850744534739631_3618294844868527772_n.jpg',
    badgeBn: 'বিশ্বনাথ শাখা',
  },
];
