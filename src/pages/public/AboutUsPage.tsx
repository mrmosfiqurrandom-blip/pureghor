    ...
    <div className="py-10 md:py-16 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 font-['Hind_Siliguri']">
      ...
      <div className="text-center max-w-2xl mx-auto mb-12">
        ...
        <h1 className="text-3xl sm:text-4xl font-black text-[#123B2A] mt-3">
          {settings.storeNameBn} — খাঁটি পণ্যের বিশ্বস্ত প্রতিষ্ঠান
        </h1>
        <p className="text-sm text-gray-600 mt-2 leading-relaxed">
          সিলেটের বিশ্বনাথ থেকে শুরু হওয়া আমাদের প্রাকৃতিক ও নিরাপদ খাদ্যের একনিষ্ঠ প্রয়াস
        </p>
      </div>

      {/* Main Story */}
      <div className="bg-white rounded-3xl p-6 sm:p-10 border border-[#E5E0D5] shadow-xs space-y-8">
        <div>
          <h2 className="text-xl sm:text-2xl font-bold text-[#123B2A] mb-3 flex items-center gap-2">
            <Leaf className="w-6 h-6 text-[#1F6B45]" />
            <span>কীভাবে আমাদের যাত্রা শুরু</span>
          </h2>
          <p className="text-base text-[#26312B]/90 leading-relaxed">
            {content?.storyBn ||
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4 border-t border-[#E5E0D5]">
          <div className="p-5 rounded-2xl bg-[#FFF8EA] border border-[#E5E0D5]">
            <div className="w-10 h-10 rounded-xl bg-[#1F6B45] text-white flex items-center justify-center mb-3">
              <Award className="w-5 h-5 text-[#D99A2B]" />
            </div>
            <h3 className="font-bold text-base text-[#123B2A] mb-1">১০০% খাঁটি ও প্রাকৃতিক</h3>
          ...
          <div className="p-5 rounded-2xl bg-[#FFF8EA] border border-[#E5E0D5]">
            <div className="w-10 h-10 rounded-xl bg-[#1F6B45] text-white flex items-center justify-center mb-3">
              <Users className="w-5 h-5 text-[#D99A2B]" />
            </div>
            <h3 className="font-bold text-base text-[#123B2A] mb-1">সরাসরি কৃষক থেকে সংগ্রহ</h3>
            <p className="text-xs text-gray-600 leading-relaxed">
          ...
          <div className="p-5 rounded-2xl bg-[#FFF8EA] border border-[#E5E0D5]">
            ...
            <h3 className="font-bold text-base text-[#123B2A] mb-1">ল্যাব টেস্ট ও সুরক্ষা</h3>
            <p className="text-xs text-gray-600 leading-relaxed">
        ...
        <div className="pt-4 border-t border-[#E5E0D5]">
          <h3 className="text-lg font-bold text-[#123B2A] mb-2">আমাদের সোর্সিং ও দায়িত্বশীলতা</h3>
