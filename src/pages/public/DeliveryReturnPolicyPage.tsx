  ...
  return (
    <div className="py-10 md:py-16 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 font-['Hind_Siliguri']">
      <div className="text-center max-w-2xl mx-auto mb-10">
        ...
        <h1 className="text-3xl font-black text-[#123B2A] mt-3">
      ...
      <div className="bg-white rounded-3xl p-6 sm:p-10 border border-[#E5E0D5] shadow-xs space-y-8 text-sm leading-relaxed text-[#26312B]/90">
        <div>
          <h2 className="text-lg font-bold text-[#123B2A] mb-2 flex items-center gap-2">
            <Truck className="w-5 h-5 text-[#1F6B45]" />
        ...
        <div className="pt-4 border-t border-[#E5E0D5]">
          <h2 className="text-lg font-bold text-[#123B2A] mb-2 flex items-center gap-2">
            <RotateCcw className="w-5 h-5 text-[#1F6B45]" />
          ...
          <p className="mt-3">
            তাহলে ডেলিভারির ৪৮ ঘণ্টার মধ্যে আমাদের কাস্টমার কেয়ারে কল (<strong>{settings.phone}</strong>) বা হোয়াটসঅ্যাপে পার্সেলের ছবি পাঠিয়ে জানালে আমরা সম্পূর্ণ ফ্রিতে নতুন পণ্য পাঠিয়ে দেব অথবা আপনার পরিশোধিত টাকা রিফান্ড করব।
          </p>
        </div>
      </div>
    </div>
