  ...
  if (!product) {
    return (
      <div className="max-w-4xl mx-auto px-4 py-24 text-center">
        <h2 className="text-2xl font-bold text-[#004F18] mb-4">পণ্য পাওয়া যায়নি</h2>
        <p className="text-gray-500 mb-6">আপনার খোঁজা পণ্যটি উপলব্ধ নেই বা নাম পরিবর্তন করা হয়েছে।</p>
        <button
          onClick={() => onNavigate('/shop')}
          className="bg-[#004F18] hover:bg-[#063B14] text-white px-6 py-3 rounded-full text-sm font-bold cursor-pointer transition-colors"
        >
          শপে ফিরে যান
        </button>
      </div>
  ...
  return (
    <div className="py-6 md:py-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="flex flex-wrap items-center gap-2 text-xs font-semibold text-gray-500 mb-6 font-['Hind_Siliguri']">
        ...
        {category && (
          <>
            ...
            <button
              ...
              className="hover:text-[#004F18] cursor-pointer"
            >
              {category.nameBn}
            </button>
          </>
        ...
        <ChevronRight className="w-3.5 h-3.5" />
        <span className="text-[#004F18] font-bold truncate max-w-xs">{product.nameBn}</span>
      </div>

      {/* Main Product Section: Gallery & Details */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 bg-white rounded-3xl p-5 sm:p-8 border border-[#DCECD5] shadow-xs">
        ...
        <div className="lg:col-span-6 space-y-4">
          <div className="relative aspect-square w-full rounded-2xl overflow-hidden bg-[#F5FBF2] border border-[#DCECD5] group">
            ...
            {hasDiscount && (
              <div className="absolute top-4 left-4 bg-[#5EB809] text-white text-xs font-black px-3 py-1.5 rounded-lg shadow-sm font-['Hind_Siliguri']">
                ...
                <button
                  ...
                  className={`w-20 h-20 rounded-xl overflow-hidden border-2 shrink-0 transition-all cursor-pointer ${
                    activeImageIndex === idx
                      ? 'border-[#004F18] ring-2 ring-[#5EB809]/30'
        ...
        <div className="lg:col-span-6 flex flex-col justify-between space-y-6">
          <div>
            ...
            <div className="flex items-center justify-between text-xs text-gray-500 mb-2">
              ...
              <button
                onClick={handleShare}
                className="flex items-center gap-1 text-[#004F18] font-bold hover:underline cursor-pointer"
              >
            ...
            {/* Title */}
            <h1 className="text-2xl sm:text-3xl font-black text-[#004F18] font-['Hind_Siliguri'] leading-tight">
              {product.nameBn}
            </h1>
            ...
            <div className="flex items-center gap-3 mt-3">
              ...
              <span className="text-xs text-[#004F18] font-bold bg-[#E8F8D8] px-2 py-0.5 rounded border border-[#DCECD5]">
                ভেরিফায়েড পিওর পণ্য
              </span>
            </div>

            {/* Short Description */}
            <p className="text-sm text-[#102B16]/80 mt-4 leading-relaxed font-['Hind_Siliguri']">
              {product.shortDescriptionBn}
            </p>

            {/* Price Box */}
            <div className="mt-5 p-4 rounded-2xl bg-[#F5FBF2] border border-[#DCECD5]">
              <div className="flex items-baseline gap-3">
                <span className="text-3xl font-black text-[#004F18] font-['Hind_Siliguri']">
                ...
                {hasDiscount && (
                  <>
                    ...
                    <span className="text-xs font-bold text-[#004F18] bg-[#E8F8D8] px-2 py-0.5 rounded border border-[#5EB809]/30">
                    ...
                    return (
                      <button
                        ...
                        className={`px-4 py-2.5 rounded-xl border text-xs font-bold transition-all cursor-pointer ${
                          isSelected
                            ? 'border-[#004F18] bg-[#004F18] text-white shadow-xs'
                            : 'border-[#DCECD5] bg-white text-[#102B16] hover:border-[#5EB809]'
                        }`}
                      >
                        <div>
                          {opt.weight} {opt.unit}
            ...
            <div className="mt-6 flex items-center gap-4">
              <div className="flex items-center border border-[#DCECD5] rounded-xl overflow-hidden bg-[#F5FBF2]">
                <button
                  onClick={() => setQuantity(Math.max(1, quantity - 1))}
                  className="px-3 py-2.5 text-gray-600 hover:bg-[#004F18] hover:text-white transition-colors cursor-pointer"
                >
                  <Minus className="w-4 h-4" />
                </button>
                <span className="px-4 text-sm font-bold text-[#004F18] min-w-[2rem] text-center">
                  {quantity}
                </span>
                <button
              ...
              <div>
                {isOutOfStock ? (
                  ...
                  <span className="text-xs font-bold text-[#004F18] bg-[#E8F8D8] px-3 py-1.5 rounded-lg border border-[#DCECD5]">
                    ইন-স্টক (তাজা স্টক)
                  </span>
                )}
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-6">
              <button
                ...
                className="min-h-[48px] bg-[#F5FBF2] hover:bg-[#004F18] text-[#004F18] hover:text-white border-2 border-[#004F18] rounded-2xl font-black text-sm flex items-center justify-center gap-2 transition-all cursor-pointer disabled:opacity-50 font-['Hind_Siliguri']"
              >
              ...
              <button
                ...
                disabled={isOutOfStock}
                className="min-h-[48px] bg-[#004F18] hover:bg-[#063B14] text-white rounded-2xl font-black text-sm flex items-center justify-center gap-2 shadow-md active:scale-98 transition-all cursor-pointer disabled:opacity-50 font-['Hind_Siliguri']"
              >
                <Zap className="w-4 h-4 text-[#5EB809] fill-current" />
          ...
          <div className="pt-6 border-t border-[#DCECD5] space-y-2 text-xs text-[#102B16]/80">
            <div className="flex items-center gap-2">
              <Truck className="w-4 h-4 text-[#004F18]" />
              <span>
                <strong>ডেলিভারি:</strong> সিলেট ও ঢাকা ২৪-৪৮ ঘণ্টা, ঢাকার বাইরে ২-৩ দিন।
              </span>
            </div>
            <div className="flex items-center gap-2">
              <ShieldCheck className="w-4 h-4 text-[#004F18]" />
              <span>
                <strong>পেমেন্ট:</strong> ক্যাশ অন ডেলিভারি (পণ্য দেখে মূল্য পরিশোধের সুবিধা)।
              </span>
            </div>
            <div className="flex items-center gap-2">
              <RotateCcw className="w-4 h-4 text-[#004F18]" />
              <span>
      ...
      <div className="mt-12 bg-white rounded-3xl p-6 sm:p-8 border border-[#DCECD5] shadow-xs">
        {/* Tabs Bar */}
        <div className="flex overflow-x-auto gap-2 border-b border-[#DCECD5] pb-4 mb-6 scrollbar-none font-['Hind_Siliguri'] font-bold text-sm">
          {[
            ...
            <button
              ...
              className={`px-4 py-2.5 rounded-xl whitespace-nowrap transition-all cursor-pointer ${
                activeTab === tab.id
                  ...
                  : 'text-[#102B16]/70 hover:bg-[#F5FBF2] hover:text-[#004F18]'
              }`}
            >
              {tab.label}
            </button>
        ...
        {/* Tab Contents */}
        <div className="text-sm leading-relaxed text-[#102B16]/90 font-['Hind_Siliguri']">
          {activeTab === 'description' && (
            <div className="space-y-4">
              <h3 className="text-lg font-bold text-[#004F18]">{product.nameBn} এর বিস্তারিত</h3>
          ...
          {activeTab === 'ingredients' && (
            <div className="space-y-4">
              <div>
                <h4 className="font-bold text-[#004F18] mb-1">উপাদান:</h4>
                <p>{product.ingredients || '১০০% প্রাকৃতিক ও খাঁটি উপাদান।'}</p>
              </div>
              <div>
                <h4 className="font-bold text-[#004F18] mb-1">পুষ্টিমান (Nutrition Facts):</h4>
          ...
          {activeTab === 'source' && (
            <div className="space-y-3">
              <h4 className="font-bold text-[#004F18]">সংগ্রহের স্থান ও কৃষক পরিচিতি</h4>
          ...
          {activeTab === 'storage' && (
            <div className="space-y-3">
              <h4 className="font-bold text-[#004F18]">সংরক্ষণ নির্দেশিকা ও মেয়াদ</h4>
          ...
          {activeTab === 'delivery' && (
            <div className="space-y-3">
              <h4 className="font-bold text-[#004F18]">ডেলিভারি ও ক্যাশ অন ডেলিভারি পলিসি</h4>
              <p>
          ...
          {activeTab === 'reviews' && (
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <h4 className="font-bold text-[#004F18]">গ্রাহকদের মূল্যায়ন ({productReviews.length})</h4>
              </div>
              {productReviews.length > 0 ? (
                <div className="space-y-4">
                  {productReviews.map((r) => (
                    <div key={r.id} className="p-4 rounded-2xl bg-[#F5FBF2] border border-[#DCECD5]">
                      <div className="flex items-center justify-between mb-2">
                        <span className="font-bold text-[#004F18]">{r.customerName}</span>
                        <div className="flex text-[#E89D10]">
      ...
      {relatedProducts.length > 0 && (
        <div className="mt-14">
          <h2 className="text-xl sm:text-2xl font-black text-[#004F18] font-['Hind_Siliguri'] mb-6">
