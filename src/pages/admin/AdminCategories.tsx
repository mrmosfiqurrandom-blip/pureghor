  ...
  return (
    <div className="space-y-6 font-['Hind_Siliguri']">
      <div className="bg-white p-4 sm:p-6 rounded-3xl border border-[#E5E0D5] flex items-center justify-between shadow-2xs">
        <div>
          <h2 className="text-base font-bold text-[#123B2A]">সকল ক্যাটাগরি তালিকা</h2>
          ...
          >
            <div>
              <div className="flex items-center gap-4 mb-3">
                <div className="w-14 h-14 rounded-2xl bg-[#FAF6EE] border border-[#E5E0D5] overflow-hidden shrink-0">
                  {cat.imageUrl ? (
                ...
                <div>
                  <h3 className="font-bold text-base text-[#123B2A] font-['Hind_Siliguri']">
                    {cat.nameBn}
                  </h3>
            ...
            <div className="flex justify-between items-center pt-4 border-t border-[#E5E0D5] mt-4">
      ...
      {editingCat && (
        <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl max-w-md w-full p-6 border border-[#E5E0D5]">
            <h3 className="text-lg font-bold text-[#123B2A] mb-4">ক্যাটাগরি তথ্য</h3>
            <form onSubmit={handleSave} className="space-y-4 text-sm">
              ...
              <div>
                ...
                <label className="flex items-center justify-center gap-2 border-2 border-dashed border-[#E5E0D5] p-3 rounded-xl cursor-pointer hover:border-[#1F6B45]">
                  ...
                  <span className="text-xs text-gray-500 font-bold">ইমেজ ফাইল আপলোড</span>
              ...
              <div className="flex justify-end gap-2 pt-2">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="px-5 py-2 rounded-xl bg-[#1F6B45] text-white text-xs font-bold cursor-pointer"
                >
                  সংরক্ষণ করুন
                </button>
              </div>
